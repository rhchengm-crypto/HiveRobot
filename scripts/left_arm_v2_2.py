#!/usr/bin/env python3
"""Clean left-arm bring-up controller v2.2.
...
v2.2 adds coupled clearance moves for shoulder_front, shoulder_side, and elbow.
"""
            ...
            for name in ordered:
                ...
                if name == "elbow" and "shoulder_front" in targets and "shoulder_side" in targets:
                    ...
                    for group_name in group_names:
                        ...
                        print("v2.2 home coupled gains", group_name, "kp=", gains["kp"], "kd=", gains["kd"], "seconds=", coupled_seconds)
        ...
        if args.cmd == "clearance":
            ...
            for name in ordered:
                ...
                if (
                    ...
                    for group_name in group_names:
                        gains = move_gains[group_name]
                        print("v2.2 clearance coupled gains", group_name, "kp=", gains["kp"], "kd=", gains["kd"], "seconds=", coupled_seconds)
                    print(
                        "v2.2 clearance coupled continuous interpolation steps_removed=",
                        coupled_steps,
                        "raw_seconds=",
                        raw_coupled_seconds,
                        "used_seconds=",
