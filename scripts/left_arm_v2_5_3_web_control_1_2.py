...
DEFAULT_MOVE_SCRIPT = os.path.join(SCRIPT_DIR, "left_arm_v2_5_3_move_library.py")
DEFAULT_RUN_LOG = os.path.join(SCRIPT_DIR, "data", "left_arm_v2_5_3_web_runs.jsonl")
DEFAULT_MOVES_FILE = os.path.join(SCRIPT_DIR, "data", "left_arm_v2_5_3_saved_moves.json")
